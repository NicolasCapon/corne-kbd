...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 KC_NO, KC_W, KC_X, KC_C, KC_V, KC_B, KC_N, KC_DOT, LCTL_T(KC_COMM), KC_COLN, LT(2,KC_QUES), KC_TRNS,
 ...
 KC_TILD, KC_PERC, KC_MINS, KC_LCBR, KC_RCBR, KC_UNDS, KC_0, KC_1, KC_2, KC_3, KC_DLR, TO(0),
