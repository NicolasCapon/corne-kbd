...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 KC_LGUI, LCTL_T(KC_SPC), KC_SPC, LT(1,KC_ENT), LSFT_T(KC_BSPC), LALT_T(KC_TAB)),
	// French symbols
 ...
 KC_WFWD, KC_BTN3, KC_CUT, KC_COPY, KC_PSTE, KC_WSCH, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, KC_NO, TO(0), 
